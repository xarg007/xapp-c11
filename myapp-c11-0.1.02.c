...
#if 0
xadmin@hw:~/ xwks.git.1 / xapp - c11$ gcc - std = c11 - g - Wall - O0 myapp - c11 - 0.1.02.c - o myapp - lpthread
xadmin@hw : ~/ xwks.git.1 / xapp - c11$ valgrind --tool = memcheck --leak - check = full --track - origins = yes - s . / myapp
== 253263 == Memcheck, a memory error detector
== 253263 == Copyright(C) 2002 - 2017, and GNU GPL'd, by Julian Seward et al.
== 253263 == Using Valgrind - 3.15.0 and LibVEX; rerun with - h for copyright info
== 253263 == Command: . / myapp
== 253263==
>> the app starting ... ...
...
0x00001ffefffee8 | 00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F | 0123456789ABCDEF|
============================================================================ =
0x00000000 | 4f 02 00 ff 1f 00 00 00  00 00 00 00 00 00 00 00 | O............... |
0x00000010 | 57 02 00 ff 1f 00 00 00  78 02 00 ff 1f 00 00 00 | W.......x....... |
0x00000020 | 98 02 00 ff 1f 00 00 00  b0 02 00 ff 1f 00 00 00 | ................ |
0x00000030 | bc 02 00 ff 1f 00 00 00  d0 02 00 ff 1f 00 00 00 | ................ |
0x00000040 | e3 02 00 ff 1f 00 00 00  f8 02 00 ff 1f 00 00 00 | ................ |
0x00000050 | 00 03 00 ff 1f 00 00 00  1f 03 00 ff 1f 00 00 00 | ................ |
0x00000060 | 31 03 00 ff 1f 00 00 00  50 03 00 ff 1f 00 00 00 | 1.......P....... |
0x00000070 | 67 03 00 ff 1f 00 00 00  87 03 00 ff 1f 00 00 00 | g............... |
0x00000080 | a3 03 00 ff 1f 00 00 00  bb 03 00 ff 1f 00 00 00 | ................ |
0x00000090 | cb 03 00 ff 1f 00 00 00  01 04 00 ff 1f 00 00 00 | ................ |
0x000000a0 | 15 04 00 ff 1f 00 00 00  27 * *************| ........'*******|
============================================================================ =


0x00001fff00024f | 00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F | 0123456789ABCDEF|
============================================================================ =
0x00000000 | 2e 2f 6d 79 61 70 70 00  47 4a 53 5f 44 45 42 55 | . / myapp.GJS_DEBU |
0x00000010 | 47 5f 54 4f 50 49 43 53  3d 4a 53 20 45 52 52 4f | G_TOPICS = JS ERRO |
0x00000020 | 52 3b 4a 53 20 4c 4f 47  00 4c 45 53 53 4f 50 45 | R; JS LOG.LESSOPE |
0x00000030 | 4e 3d 7c 20 2f 75 73 72  2f 62 69 6e 2f 6c 65 73 | N = | /usr / bin / les |
0x00000040 | 73 70 69 70 65 20 25 73  00 4c 41 4e 47 55 41 47 | spipe % s.LANGUAG |
0x00000050 | 45 3d 7a 68 5f 43 4e 3a  65 6e 5f 55 53 3a 65 6e | E = zh_CN:en_US:en |
0x00000060 | 00 55 53 45 52 3d 78 61  64 6d 69 6e 00 4c 43 5f | .USER = xadmin.LC_ |
0x00000070 | 54 49 4d 45 3d 7a 68 5f  43 4e 2e 55 54 46 2d 38 | TIME = zh_CN.UTF - 8 |
0x00000080 | 00 53 53 48 5f 41 47 45  4e 54 5f 50 49 44 3d 31 | .SSH_AGENT_PID = 1 |
0x00000090 | 38 30 32 00 58 44 47 5f  53 45 53 53 49 4f 4e 5f | 802.XDG_SESSION_ |
0x000000a0 | 54 59 50 45 3d 78 31 31  00 * *************| TYPE = x11.* * *****|
============================================================================ =
...
0x00001ffefffd80 | 00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F | 0123456789ABCDEF|
============================================================================ =
0x00000000 | 60 20 20 20 31 32 33 34  2e 2e 2e 2e 5c 30 00 2e | `   1234....\0.. |
0x00000010 | 37 38 39 30 7e 21 40 23  24 25 5e 26 2a 28 29 5f | 7890~!@#$ % ^&*()_ |
0x00000020 | 2b 2d 3d 71 77 65 72 74  79 75 69 6f 70 5b 5d 5c | +-= qwertyuiop[]\ |
...
== 253263==
==253263 == HEAP SUMMARY :
== 253263 == in use at exit : 0 bytes in 0 blocks
== 253263 == total heap usage : 4 allocs, 4 frees, 211, 512 bytes allocated
== 253263==
==253263 == All heap blocks were freed -- no leaks are possible
== 253263==
==253263 == ERROR SUMMARY : 0 errors from 0 contexts(suppressed : 0 from 0)
xadmin@hw : ~/ xwks.git.1 / xapp - c11$
