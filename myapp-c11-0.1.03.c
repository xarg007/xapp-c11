	...
	for (unsigned int i = 0; i < iRow; i++)
	{
		...
		for (unsigned int j = 0; j < 16; j++)
		{
			if ((i * 16 + j) < iLen)
			{
				...
				if (j < 15) xlog_info(" %c ", test_char);
				else        xlog_info(" %c" , test_char);
			}
			else
			{
				if (j < 15) xlog_info("** ");
	...
	for (unsigned int i = 0; i < iRow; i++)
	{
		...
		for (unsigned int j = 0; j < 16; j++)
		{
			if ((i * 16 + j) < iLen)
			{
				...
				if (j < 15) xlog_info("%c(%02x) ", test_char, test_char);
				else        xlog_info("%c(%02x)" , test_char, test_char);
			}
			else
			{
				if (j < 15) xlog_info("**    ");
...
==253350== Memcheck, a memory error detector
==253350== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==253350== Using Valgrind-3.15.0 and LibVEX; rerun with -h for copyright info
==253350== Command: ./myapp
==253350== 
  >> func:main(1, 0x1ffefffee8) is called. (@file:myapp-c11-0.1.03.c,line:0550).
  >> func:main(1, 0x1ffefffee8) is called. (@file:myapp-c11-0.1.03.c,line:0551).
  >> func{main:(00557)()}. pFileNameSelf=./myapp, pFileNameTarget=(null).
  >> func{main:(00562)@(myapp-c11-0.1.03.c)(param tbc)} is error !!
==253350== 
==253350== HEAP SUMMARY:
==253350==     in use at exit: 0 bytes in 0 blocks
==253350==   total heap usage: 1 allocs, 1 frees, 1,024 bytes allocated
==253350== 
==253350== All heap blocks were freed -- no leaks are possible
==253350== 
==253350== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
xadmin@hw:~/xwks.git.1/xapp-c11$ valgrind --tool=memcheck --leak-check=full --track-origins=yes -s ./myapp myapp
==253352== Memcheck, a memory error detector
==253352== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==253352== Using Valgrind-3.15.0 and LibVEX; rerun with -h for copyright info
==253352== Command: ./myapp myapp
==253352== 
  >> func:main(2, 0x1ffefffed8) is called. (@file:myapp-c11-0.1.03.c,line:0550).
  >> func:main(2, 0x1ffefffed8) is called. (@file:myapp-c11-0.1.03.c,line:0551).
  >> func{main:(00557)()}. pFileNameSelf=./myapp, pFileNameTarget=myapp.
  >> func{getDataFromFile:(00521)} is call ,pFileName="myapp".
  >> func{main:(00577)} is call, pHexData="0x4a5c6a0" .

0x00001ffefffed8|00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F|0123456789ABCDEF|
      =============================================================================
      0x00000000|4b 02 00 ff 1f 00 00 00  53 02 00 ff 1f 00 00 00|K.......S.......|
      0x00000010|00 00 00 00 00 00 00 00  59 02 00 ff 1f 00 00 00|........Y.......|
      0x00000020|7a 02 00 ff 1f 00 00 00  9a 02 00 ff 1f 00 00 00|z...............|
      0x00000030|b2 02 00 ff 1f 00 00 00  be 02 00 ff 1f 00 00 00|................|
      0x00000040|d2 02 00 ff 1f 00 00 00  e5 02 00 ff 1f 00 00 00|................|
      0x00000050|fa 02 00 ff 1f 00 00 00  02 03 00 ff 1f 00 00 00|................|
      0x00000060|21 03 00 ff 1f 00 00 00  33 03 00 ff 1f 00 00 00|!.......3.......|
      0x00000070|52 03 00 ff 1f 00 00 00  69 03 00 ff 1f 00 00 00|R.......i.......|
      0x00000080|89 03 00 ff 1f 00 00 00  a5 03 00 ff 1f 00 00 00|................|
      0x00000090|bd 03 00 ff 1f 00 00 00  cd 03 00 ff 1f 00 00 00|................|
      0x000000a0|03 04 00 ff 1f 00 00 00  17 ** ** ** ** ** ** **|.........*******|
      =============================================================================
...
0x00001ffefffed8|00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F|0123456789ABCDEF|
      ...
      ===========================================================
      >> ptr[000] = 0x00001fff00024b;
      >> ptr[001] = 0x00001fff000253;
      >> ptr[002] =            (nil);
      ===========================================================

      ===========================================================
      >> ptr[000]=0x00001fff00024b; str={"./myapp"};
      >> ptr[001]=0x00001fff000253; str={"myapp"};
      >> ptr[002]=0x00001fff000259; str={"GJS_DEBUG_TOPICS=JS ERROR;JS LOG"};
      >> ptr[003]=0x00001fff00027a; str={"LESSOPEN=| /usr/bin/lesspipe %s"};
      >> ptr[004]=0x00001fff00029a; str={"LANGUAGE=zh_CN:en_US:en"};
      >> ptr[005]=0x00001fff0002b2; str={"USER=xadmin"};
      >> ptr[006]=0x00001fff0002be; str={"LC_TIME=zh_CN.UTF-8"};
      ===========================================================

  >> func{DumpHex2Char:(00371)} is call.{pData=0x1fff00024b, iLen=169}.

      0x????????|00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F|
      ===========================================================
      0x00000000| .  /  m  y  a  p  p     m  y  a  p  p     G  J|
      0x00000010| S  _  D  E  B  U  G  _  T  O  P  I  C  S  =  J|
      0x00000020| S     E  R  R  O  R  ;  J  S     L  O  G     L|
      0x00000030| E  S  S  O  P  E  N  =  |     /  u  s  r  /  b|
      0x00000040| i  n  /  l  e  s  s  p  i  p  e     %  s     L|
      0x00000050| A  N  G  U  A  G  E  =  z  h  _  C  N  :  e  n|
      0x00000060| _  U  S  :  e  n     U  S  E  R  =  x  a  d  m|
      0x00000070| i  n     L  C  _  T  I  M  E  =  z  h  _  C  N|
      0x00000080| .  U  T  F  -  8     S  S  H  _  A  G  E  N  T|
      0x00000090| _  P  I  D  =  1  8  0  2     X  D  G  _  S  E|
      0x000000a0| S  S  I  O  N  _  T  Y  P ** ** ** ** ** ** **|

  >> func{DumpHex2CharA:(00471)} is call.{pData=0x1fff00024b, iLen=169}.

      0x????????|00    01    02    03    04    05    06    07    08    09    0A    0B    0C    0D    0E    0F   |
      ===========================================================================================================
      0x00000000|.(2e) /(2f) m(6d) y(79) a(61) p(70) p(70) .(2e) m(6d) y(79) a(61) p(70) p(70) .(2e) G(47) J(4a)|
      0x00000010|S(53) _(5f) D(44) E(45) B(42) U(55) G(47) _(5f) T(54) O(4f) P(50) I(49) C(43) S(53) =(3d) J(4a)|
      0x00000020|S(53)  (20) E(45) R(52) R(52) O(4f) R(52) ;(3b) J(4a) S(53)  (20) L(4c) O(4f) G(47) .(2e) L(4c)|
      0x00000030|E(45) S(53) S(53) O(4f) P(50) E(45) N(4e) =(3d) |(7c)  (20) /(2f) u(75) s(73) r(72) /(2f) b(62)|
      0x00000040|i(69) n(6e) /(2f) l(6c) e(65) s(73) s(73) p(70) i(69) p(70) e(65)  (20) %(25) s(73) .(2e) L(4c)|
      0x00000050|A(41) N(4e) G(47) U(55) A(41) G(47) E(45) =(3d) z(7a) h(68) _(5f) C(43) N(4e) :(3a) e(65) n(6e)|
      0x00000060|_(5f) U(55) S(53) :(3a) e(65) n(6e) .(2e) U(55) S(53) E(45) R(52) =(3d) x(78) a(61) d(64) m(6d)|
      0x00000070|i(69) n(6e) .(2e) L(4c) C(43) _(5f) T(54) I(49) M(4d) E(45) =(3d) z(7a) h(68) _(5f) C(43) N(4e)|
      0x00000080|.(2e) U(55) T(54) F(46) -(2d) 8(38) .(2e) S(53) S(53) H(48) _(5f) A(41) G(47) E(45) N(4e) T(54)|
      0x00000090|_(5f) P(50) I(49) D(44) =(3d) 1(31) 8(38) 0(30) 2(32) .(2e) X(58) D(44) G(47) _(5f) S(53) E(45)|
      0x000000a0|S(53) S(53) I(49) O(4f) N(4e) _(5f) T(54) Y(59) P(50) **    **    **    **    **    **    **   |
      ===========================================================================================================

  >> func{DumpHex2CharB:(00421)} is call.{pData=0x1fff00024b, iLen=169}.

      0x????????|0123456789ABCDEF|
      ===========================================================
      0x00000000|./myapp myapp GJ|
      0x00000010|S_DEBUG_TOPICS=J|
      0x00000020|S ERROR;JS LOG L|
      0x00000030|ESSOPEN=| /usr/b|
      0x00000040|in/lesspipe %s L|
      0x00000050|ANGUAGE=zh_CN:en|
      0x00000060|_US:en USER=xadm|
      0x00000070|in LC_TIME=zh_CN|
      0x00000080|.UTF-8 SSH_AGENT|
      0x00000090|_PID=1802 XDG_SE|
      0x000000a0|SSION_TYP*******|


0x00001fff00024b|00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F|0123456789ABCDEF|
      =============================================================================
      0x00000000|2e 2f 6d 79 61 70 70 00  6d 79 61 70 70 00 47 4a|./myapp.myapp.GJ|
      0x00000010|53 5f 44 45 42 55 47 5f  54 4f 50 49 43 53 3d 4a|S_DEBUG_TOPICS=J|
      0x00000020|53 20 45 52 52 4f 52 3b  4a 53 20 4c 4f 47 00 4c|S ERROR;JS LOG.L|
      0x00000030|45 53 53 4f 50 45 4e 3d  7c 20 2f 75 73 72 2f 62|ESSOPEN=| /usr/b|
      0x00000040|69 6e 2f 6c 65 73 73 70  69 70 65 20 25 73 00 4c|in/lesspipe %s.L|
      0x00000050|41 4e 47 55 41 47 45 3d  7a 68 5f 43 4e 3a 65 6e|ANGUAGE=zh_CN:en|
      0x00000060|5f 55 53 3a 65 6e 00 55  53 45 52 3d 78 61 64 6d|_US:en.USER=xadm|
      0x00000070|69 6e 00 4c 43 5f 54 49  4d 45 3d 7a 68 5f 43 4e|in.LC_TIME=zh_CN|
      0x00000080|2e 55 54 46 2d 38 00 53  53 48 5f 41 47 45 4e 54|.UTF-8.SSH_AGENT|
      0x00000090|5f 50 49 44 3d 31 38 30  32 00 58 44 47 5f 53 45|_PID=1802.XDG_SE|
      0x000000a0|53 53 49 4f 4e 5f 54 59  50 ** ** ** ** ** ** **|SSION_TYP*******|
      =============================================================================
...
0x00000004a5c6a0|00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F|0123456789ABCDEF|
      ...
      0x00000000|7f 45 4c 46 02 01 01 00  00 00 00 00 00 00 00 00|.ELF............|
      0x00000010|03 00 3e 00 01 00 00 00  a0 11 00 00 00 00 00 00|..>.............|
      0x00000020|40 00 00 00 00 00 00 00  30 6e 00 00 00 00 00 00|@.......0n......|
      0x00000030|00 00 00 00 40 00 38 00  0d 00 40 00 24 00 23 00|....@.8...@.$.#.|
      0x00000040|06 00 00 00 04 00 00 00  40 00 00 00 00 00 00 00|........@.......|
      0x00000050|40 00 00 00 00 00 00 00  40 00 00 00 00 00 00 00|@.......@.......|
      0x00000060|d8 02 00 00 00 00 00 00  d8 02 00 00 00 00 00 00|................|
      ...
      0x000000e0|00 10 00 00 00 00 00 00  01 00 00 00 05 00 00 00|................|
      0x000000f0|00 10 00 00 00 00 00 00  00 10 00 00 00 00 00 00|................|
      0x00000100|00 10 00 00 00 00 00 00  91 1b 00 00 00 00 00 00|................|
      0x00000110|91 1b 00 00 00 00 00 00  00 10 00 00 00 00 00 00|................|
      0x00000120|01 00 00 00 04 00 00 00  00 30 00 00 00 00 00 00|.........0......|
      0x00000130|00 30 00 00 00 00 00 00  00 30 00 00 00 00 00 00|.0.......0......|
      0x00000140|00 08 00 00 00 00 00 00  00 08 00 00 00 00 00 00|................|
      0x00000150|00 10 00 00 00 00 00 00  01 00 00 00 06 00 00 00|................|
...
0x00001ffefffd70|00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F|0123456789ABCDEF|
      =============================================================================
      0x00000000|60 20 20 20 31 32 33 34  2e 2e 2e 2e 5c 30 00 2e|`   1234....\0..|
      0x00000010|37 38 39 30 7e 21 40 23  24 25 5e 26 2a 28 29 5f|7890~!@#$%^&*()_|
      0x00000020|2b 2d 3d 71 77 65 72 74  79 75 69 6f 70 5b 5d 5c|+-=qwertyuiop[]\|
...
0x00001ffefffd70|00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F|0123456789ABCDEF|
  ...
  >> func:main() is called. (@file:myapp-c11-0.1.03.c,line:0603).
==253352== 
==253352== HEAP SUMMARY:
==253352==     in use at exit: 0 bytes in 0 blocks
==253352==   total heap usage: 4 allocs, 4 frees, 36,104 bytes allocated
==253352== 
==253352== All heap blocks were freed -- no leaks are possible
==253352== 
==253352== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
xadmin@hw:~/xwks.git.1/xapp-c11$ 
